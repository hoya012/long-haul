---
layout: post
title:  “SIGGRAPH 2018 review [2] 주요 논문 소개 및 리뷰”
date:   2018-12-17
...
이 논문은 원본 이미지에 해당하는 특징점들(원)에 해당하는 특징점들을 다른 도메인의 이미지에 대해서 찾는 연구를 진행하였습니다. 
...
보통 고정된 압축률을 사용하는데, 이미지마다 더 압축을 시켜도 사람이 크게 열화를 느끼지 못하는 경우에는 더 압축을 해도 되지만 그렇지 않고 사용을 하고 있습니다. 
