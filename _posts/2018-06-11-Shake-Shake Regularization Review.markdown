...
{:.caption}
{% include image.html name=page.name file="shake_shake/Image_Flip.PNG" description="*이미지 반전 예시*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Image_Rotation.PNG" description="*이미지 회전 예시*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Image_Crop.png" description="*이미지 자르기 예시*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Image_Color_jittering.png" description="*Color jittering 예시*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/MNIST_false_aug_example.png" description="*MNIST 데이터셋 잘못된 증강 예시*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Fig_1_shake_shake_example.PNG" description="*Shake Shake 예시*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/related_work.PNG" description="*선행 연구*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/ShakeNet_Architecture.PNG" description="*ShakeNet Architecture*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Table_1_option.PNG" description="*3가지 옵션에 따른 성능 결과*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Table_3_Result.PNG" description="*기존 SOTA 망과 성능 비교 결과*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/correlation_result.PNG" description="*Residual branch간 correlation 분석*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Fig_5_alpha.PNG" description="*β 값 결정 방법에 따른 성능 변화*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/cifar10_example.PNG" description="*CIFAR-10  예시*" class="full-image" %}
...
```dataset.cifar10``` 모듈은 데이터셋 요소에 해당하는 함수들과 클래스 정보를 담고 있습니다. <a href="http://research.sualab.com/machine-learning/computer-vision/2018/01/17/image-classification-deep-learning.html" target="_blank"> **수아랩 기술블로그의 포스팅**</a>  에서 사용했던 코드를 기반으로 작성을 하였기 때문에 모든 코드를 설명하기보다는 달라진 부분 위주로 설명을 드리겠습니다.
...
성능 평가와 관련된 모듈들은 <a href="http://research.sualab.com/machine-learning/computer-vision/2018/01/17/image-classification-deep-learning.html" target="_blank"> **수아랩 기술블로그의 포스팅의 구현체와**</a> 달라진 점이 없으므로 따로 설명을 하진 않겠습니다. 혹시 궁금하신 분들은 이전 포스팅을 참고하시면 됩니다.
...
이 모듈에서는 `optimizer` 클래스와, 이 클래스를 상속받는 `MomentumOptimizer` 클래스를 담고 있으며 <a href="http://research.sualab.com/machine-learning/computer-vision/2018/01/17/image-classification-deep-learning.html" target="_blank"> **수아랩 기술블로그의 포스팅**</a> 의 구조를 거의 그대로 사용하기 때문에 달라진 부분 위주로 설명을 드리겠습니다.   
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Cosine_SGDR.png" description="*Cosine annealing(SGDR)*" class="full-image" %}
...
{:.caption}
{% include image.html name=page.name file="shake_shake/Accuracy_graph.PNG" description="*학습 곡선 플롯팅 결과*" class="full-image" %}
