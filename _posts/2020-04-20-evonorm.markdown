...
Specifically, we use 24×24 random crops on We use SGD with learning rate 0.1, Nesterov momentum original 32×32 image with a batch size of 512 for validation. 0.9 and weight decay 10−4. 
